...
// Event date: single day ("February 24, 2026") or range ("February 24 – 26, 2026").
export function formatEventDateRange(startValue, endValue) {
  ...
  // Different months: "February 28 – March 2, 2026"
  const startStr = start.toLocaleDateString("en-US", { month: "long", day: "numeric" });
  const endStr = end.toLocaleDateString("en-US", { month: "long", day: "numeric", year: "numeric" });
  return `${startStr} – ${endStr}`;
}

// Time window: "9:00 am – 5:00 pm", or just the start, or "" if none.
